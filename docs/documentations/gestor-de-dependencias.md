De cara a la elección del gestor de dependencias, puesto que todos los gestores tienen la misma compatibilidad con los paquetes, se ha establecido de antemano el criterio de velocidad para agilizar el proyecto lo máximo posible y se ha tenido en cuenta las siguientes opciones:
...
Finalmente se ha optado por **pnpm**, puesto que tras comparar el rendimiento de los 3 gestores con un mismo paquete (en concreto, jakan, que es un paquete que se utilizará para extraer datos para el proyecto), se ha obtenido el resultado de que **pnpm** es la más rápida.
